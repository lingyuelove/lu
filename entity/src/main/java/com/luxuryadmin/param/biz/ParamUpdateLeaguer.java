 ...
 */
@ApiModel(description = "更新友商记录--前端接收参数模型")
public class ParamUpdateLeaguer extends ParamToken {
     ...
     * 友商记录表id
     */
    @ApiModelProperty(value = "友商记录表id", name = "leaguerId", required = true)
    @Pattern(regexp = "^[0-9]{5,9}$", message = "[leaguerId]参数非法!")
    @NotBlank(message = "[leaguerId]不允许为空!")
