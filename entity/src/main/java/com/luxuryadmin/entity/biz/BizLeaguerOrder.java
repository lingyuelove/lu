...
public class BizLeaguerOrder {
    ...
    /**
     * 买家shp_shop的id字段,主键id
     */
    private Integer fkBuyerShopId;
    ...
    /**
     * biz开头;订单编号(针对店铺的唯一订单编码)
     */
    private String number;

    /**
     * 状态  -90 已删除;-10:取消订单(买家);-11取消订单(卖家);10:已下单(待确认);11:确认订单(卖家,该状态为预留状态.用于线上物流);12:去开单(卖家);20:已收货(买家)
     */
    ...
    public Integer getFkBuyerShopId() {
        return fkBuyerShopId;
    }

    public void setFkBuyerShopId(Integer fkBuyerShopId) {
        this.fkBuyerShopId = fkBuyerShopId;
    }
