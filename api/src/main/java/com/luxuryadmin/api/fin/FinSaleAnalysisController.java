...
@Api(tags = "9.【销售】模块", description = "/shop/user/fin | 销售数据模块")
...
//以下为静态测试数据
 /* VoSaleTop saleTop2 = new VoSaleTop();
        saleTop2.setHeadImageUrl("https://hahah/touxaio/hahah");
        saleTop2.setNickname("张三测试数据2");
        saleTop2.setRole("店长");
        saleTop2.setUserNumber("88888");
        saleTop2.setSaleTotal("100000");
        saleTop2.setGrossProfit("10000");
        saleTop2.setSaleCount("3");


        VoOrderLoad order = new VoOrderLoad();
        order.setBizId("商品id");
        order.setName("标题");
        order.setDescription("描述");
        order.setInitPrice(101000);
        order.setSalePrice(151000);
        order.setSmallImg("https://hahah/touxaio/hahah");
        order.setOrderBizId("订单id");
        order.setInsertNickname("开单人员昵称");
        order.setInsertTime(new Date());


        VoOrderLoad order2 = new VoOrderLoad();
        order2.setBizId("商品id");
        order2.setName("标题");
        order2.setDescription("描述");
        order2.setInitPrice(101000);
        order2.setSalePrice(151000);
        order2.setSmallImg("https://hahah/touxaio/hahah");
        order2.setOrderBizId("订单id");
        order2.setInsertNickname("开单人员昵称");
        order2.setInsertTime(new Date());

        List<VoOrderLoad> list = new ArrayList<>();
        list.add(order);
        list.add(order2);*/