...
import com.luxuryadmin.dto.PhoneModelDTO;
...
public class PhoneUtil {
     ...
     */
    public static PhoneModelDTO getPhoneModel(String phoneNumber) {
    ...
    public static void main(String[] args) {
        PhoneModelDTO phoneModel = PhoneUtil.getPhoneModel("15214469435");
        if (phoneModel != null) {
