 ...
 */
@Mapper
public interface ShpPermUserRefMapper extends BaseMapper {
     ...
     * @return
     */
    int deletePermUserRefByShopIdAndUserId(@Param("shopId") int shopId, @Param("userId") int userId);
     ...
     * @return
     */
    int deleteShpPermUserRefByUserId(@Param("shopId") int shopId, @Param("userIds") String userIds);
