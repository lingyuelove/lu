...
public class RobotHelperUtil {
    ...
    /**
     * 钉钉群设置 webhook, 支持重置，线上异常提醒群
     */
    private static final String ACCESS_TOKEN = "https://oapi.dingtalk.com/robot/send?access_token=3471e7df29e50510b9bc77de07641ed6371a2cd9eeefdd5e1ec6ba4778355395";

    /**
     * 钉钉群设置 webhook，业务超时提醒群
     */
    private static final String TIMEOUT_TOKEN = "https://oapi.dingtalk.com/robot/send?access_token=31fc752a3c087693fa30c98195376437622a337adaee5a6048f4a282581ad11a";
    /**
     * 消息类型
     */
    ...
    public static DingTalkClient client2 = new DefaultDingTalkClient(TIMEOUT_TOKEN);
    ...
    public static void sdkDemoJava() {
        ...
        text.setContent("测试文本消息Exception");
        request.setText(text);
        OapiRobotSendRequest.At at = new OapiRobotSendRequest.At();
        at.setAtMobiles(Arrays.asList("15112304365"));
        request.setAt(at);
        ...
        link.setPicUrl("");
        link.setTitle("Exception时代的火车向前开");
        ...
        markdown.setText("Exception#### 杭州天气 @156xxxx8827\n" +
    ...
    public static OapiRobotSendResponse sendMessageByText(String content, List<String> mobileList, boolean isAtAll) {
        ...
        if (!CollectionUtils.isEmpty(mobileList)) {
            ...
            at.setIsAtAll(Boolean.valueOf(isAtAll ? "true" : "false"));
            request.setAt(at);
        }
     ...
     * @date: 2019/7/6
     */
    public static OapiRobotSendResponse timeoutTip(String content, List<String> mobileList, boolean isAtAll) {
        if (StringUtils.isEmpty(content)) {
            return null;
        }
        ...
        OapiRobotSendResponse response = new OapiRobotSendResponse();
        try {
            response = RobotHelperUtil.client2.execute(request);
        } catch (ApiException e) {
            log.error("[发送普通文本消息]: 发送消息失败, 异常捕获{}", e.getMessage());
        }
        return response;
    ...
    public static void main(String args[]) {
        try {
            ...
            mobileList.add("15112304365");
            sendMessageByText(LocalUtils.getStackTrace(e), null, false);
        }
    }
